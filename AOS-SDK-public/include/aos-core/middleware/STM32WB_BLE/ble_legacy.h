...
typedef struct
{
  uint8_t type;
  uint8_t data[1];
} __attribute__((__packed__)) hci_uart_pckt;
...
typedef struct
{
  ...
  uint8_t         plen;
  uint8_t         data[1];
} __attribute__((__packed__)) hci_event_pckt;

typedef struct
{
  uint8_t         subevent;
  uint8_t         data[1];
} __attribute__((__packed__)) evt_le_meta_event;
...
typedef struct
{
  ...
  uint8_t  data[1];
} __attribute__((__packed__)) evt_blecore_aci;
